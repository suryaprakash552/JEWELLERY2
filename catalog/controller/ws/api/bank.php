<?php
class ControllerApiBank extends Controller {
    ...
    public function register()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/bank/register',$json);
            }else
                {
    ...
    {
        $keys=array('snumber','sname','spincode','semail');
        foreach($keys as $key)
        {
    ...
    public function verify_registration()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/bank/verify_registration',$json);
            }else
                {
    ...
    public function getsender()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/bank/getsender',$json);
            }else
                {
    ...
    public function create_beneficiary()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/bank/create_beneficiary',$json);
            }else
                {
    ...
    public function account_verify()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            if($validate_accountverify['success']==1)
            {
                ...
                $json=$this->load->controller('transactions/paytm/accountverify',$json);
            }else
                {
    ...
    public function account_transfer()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/paytm/accounttransfer',$json);
            }else
                {
    ...
    {
        $keys=array('snumber','beneficiaryid','remitterid','amount','yourrequestid','transferMode');
        foreach($keys as $key)
        {
           if(!isset($raw[$key]) || empty($raw[$key]) || $raw[$key]=='')
            {
    ...
    public function payout()
    {
        ...
        //----------------------------------------------------------
            ...
            {   
                ...
                {
                    $json=$this->load->controller('transactions/paytm/payout',$json);
                }else
                    {
    ...
    public function upi_transfer()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/paytm/upitransfer',$json);
            }else
                {
    ...
    public function wallet_transfer()
    {
        ...
        if($json['success']=="1" && isset($json))
        {
            ...
            {
                $json=$this->load->controller('transactions/paytm/wallettransfer',$json);
            }else
                {

...
namespace Opencart\Catalog\Controller\Ws;
    class Common extends \Opencart\System\Engine\Controller {
        ...
        public function balance()
        {
            ...
            if($json['success']=="1" && isset($json))
            {
                $json=$this->load->controller('transactions/common/balance',$json); 
            }
               $this->response->addHeader('Content-Type: application/json');
        	   $this->response->setOutput(json_encode($json));
        }
        ...
        public function paymentrequest()
        {
            ...
            if(!$validate)
            {
                ...
                {  
                    ...
                    {
                         $json=$this->load->controller('transactions/common/paymentrequest',$json);  
                    }else
                    {
        ...
        public function paymenthistory()
        {
            ...
            if(!$validate)
            {
                ...
                { 
                    ...
                    $json=$this->load->controller('transactions/common/paymentHistory',$json);
                }
            }else
                {
                    $json=$validate;
        ...
        public function manualpaymentscallback()
       {
        ...
        public function paymentbanks()
        {
            ...
            if(!$validate)
            {
                ...
                if($json['success']=="1" && isset($json))
                {
                    ...
                    $json=$this->load->controller('transactions/common/paymentbanks',$json);
                }
            }else
                {
                    $json=$validate;
        ...
        public function update_profile()
        {
            ...
            if(!$validate)
            {
                ...
                {  
                    ...
                    {
                         $json=$this->load->controller('transactions/common/update_profile',$json);  
                    }else
                    {
        ...
        public function login()
        {
            ...
            if($validate_login['success']==1 && !empty($validate_login))
            {
                $json=array();
                $json['source']=$this->request->post['source'];
                $json=$this->load->controller('transactions/common.login',$json);
            }else
                {
                    $json=$validate_login;
                }
        ...
        public function login_password()
        {
            ...
            //print_r($validate_login_password);
            if($validate_login_password['success']==1 && !empty($validate_login_password))
            {
                $json=array();
                $json['source']=$this->request->post['source'];
                $json=$this->load->controller('transactions/common.login_password',$json);
            }else
                {
        ...
        public function verify_login()
        {
            ...
            if($validate_verify_login['success']==1 && !empty($validate_verify_login))
            {
                $json=array();
                $json['source']=$this->request->post['source'];
                $json=$this->load->controller('transactions/common.verify_login',$json);
            }else
                {
        ...
        public function complete_login()
        {
            ...
            if($validate_complete_login['success']==1 && !empty($validate_complete_login))
            {
                $json=array();
                $json['source']=$this->request->post['source'];
                $json=$this->load->controller('transactions/common.complete_login',$json);
            }else
                {
           ...
           $input = json_decode(file_get_contents("php://input"), true);
            ...
            if($json['success']==1 && isset($json))
            {
                   $validate_edit_profile=array();
                    ...
                    {
                        $json=$this->load->controller('transactions/common.edit_profile_info',$json);    
                    }else
                    {
        ...
        private function validate_edit_profile($raw)
        {
            ...
            {
                $json['success']="0";
                $json['message']=$this->language->get('error_aadharfront: '.$aadhar['message']);
                return $json;
            }
        ...
        public function profile_info()
        {
            ...
            if($json['success']==1 && isset($json))
            {
                   $json=$this->load->controller('transactions/common/profile_info',$json);    
            }
            $this->response->addHeader('Content-Type: application/json');
    		$this->response->setOutput(json_encode($json));
        }
    ...
    public function logout()
    {
        ...
        if(!$validate)
        {
            ...
            if($json['success']=="1" && isset($json))
            {  
               $json=$this->load->controller('transactions/common/logout',$json);    
            }
        }else
            {
                $json=$validate;

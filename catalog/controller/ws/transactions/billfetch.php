<?php
class ControllerTransactionsBillfetch extends Controller {
    public function index($data)
    {
        ...
        if($cust_info['exstatus'])
        {
            ...
            if($operator_info['exstatus'])
            {
                ...
                if($service_assignment['exstatus'])
                {
                    $api_billfetch_info=$this->model_transactions_common->getBillFetchAPIInfo($this->language->get('BILLFETCH'));

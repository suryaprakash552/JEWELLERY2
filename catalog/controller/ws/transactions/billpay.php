<?php
class ControllerTransactionsBillpay extends Controller {
                ...
                if($pkg_info['exstatus'])
                {
                    ...
                    if($operator_info['exstatus'])
                    {
                        ...
                        if($service_assignment['exstatus'])
                        {
                            ...
                            if($api_margins_info['exstatus'])
                            {
                                $api_info=$this->model_transactions_common->getAPIInfo($api_margins_info['apiid'],$this->language->get('type_billpay'));
                                //print_r($api_info);

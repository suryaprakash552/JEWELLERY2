<?php
class ControllerTransactionsFinoCwnew extends Controller {
                               ...
                               // print_r($apiResponse);
                                ...
                                if($apiResponse['status']==$this->language->get('SUCCESS'))
                                {
                                    $credit=array(
                                                        ...
                                                        "amount"=>$this->request->post['amount'],
                                                        "order_id"=>"0",
                                                        "description"=>$this->request->post['aepsid'].'#CW/AEPS-2#'.$this->request->post['amount'].'#'.$this->request->post['uid'],
                                                        "transactiontype"=>'CW/AEPS-2',
                                    ...
                                    $fcmResponse=$this->model_transactions_common->fcm_codeapi($record,$fcm_info);
                                      $result=json_decode($fcmResponse,true);
                                             if ($result){
                                                    ...
                                                    $json['servicetype']='Cash Wdrawl/AEPS-2';

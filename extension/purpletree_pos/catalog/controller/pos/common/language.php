...
class Language extends \Opencart\System\Engine\Controller{
	public function index() {
		...
		if (!isset($this->request->get['route'])) {
			$data['redirect'] = $this->url->link('extension/account/purpletree_multivendor/dashboardicons');
		} else {
		...
		return $this->load->view('account/purpletree_multivendor/common/language', $data);
	}

...
class Category extends \Opencart\System\Engine\Controller {
	...
	public function form(): void {
		...
		// OFFER
if (!empty($category_info)) {
    $data['offer'] = $category_info['offer'];
} else {
    $data['offer'] = '';
}
...
// OFFER FROM
if (!empty($category_info)) {
    $data['offer_from'] = $category_info['offer_from'];
} else {
    $data['offer_from'] = '';
}
...
// OFFER TO
if (!empty($category_info)) {
    $data['offer_to'] = $category_info['offer_to'];
} else {
    $data['offer_to'] = '';
}
// OFFER PERCENTAGE
if (isset($this->request->post['offer_percentage'])) {
    $data['offer_percentage'] = $this->request->post['offer_percentage'];
} elseif (!empty($category_info)) {
    $data['offer_percentage'] = $category_info['offer_percentage'];
} else {

...
class Wholesale extends \Opencart\System\Engine\Controller {
    ...
    public function index(): void {
        ...
        $initial_results = $this->model_sale_wholesale->getOrders([
            'start' => 0,
            'limit' => 10
        ]);
        ...
        $order_results = $this->model_sale_wholesale->getDailyOrderSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $product_results = $this->model_sale_wholesale->getDailyProductReport([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $number_results = $this->model_sale_wholesale->getSalesByNumber([
            'filter_phone' => '',
            'start' => 0,
            'limit' => 10
        ]);
        ...
        $seller_results = $this->model_sale_wholesale->getSellerSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $total_results = $this->model_sale_wholesale->getReport([
            'filter_date_added' => '',
        ...
        $coupon_results = $this->model_sale_wholesale->getCouponSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;

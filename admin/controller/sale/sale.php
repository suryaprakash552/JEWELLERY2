...
class Sale extends \Opencart\System\Engine\Controller {
    ...
    public function index(): void {
        ...
        $initial_results = $this->model_sale_sale->getOrders([
            'start' => 0,
            'limit' => 10
        ]);
        ...
        $order_results = $this->model_sale_sale->getDailyOrderSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $product_results = $this->model_sale_sale->getDailyProductReport([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $number_results = $this->model_sale_sale->getSalesByNumber([
            'filter_phone' => '',
            'start' => 0,
            'limit' => 10
        ]);
        ...
        $seller_results = $this->model_sale_sale->getSellerSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;
        ...
        $total_results = $this->model_sale_sale->getReport([
            'filter_date_added' => '',
        ...
        $coupon_results = $this->model_sale_sale->getCouponSummary([
            'start' => 0,
            'limit' => 10
        ]);
        $sr = 1;

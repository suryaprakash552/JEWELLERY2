...
class Order extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		if (isset($this->request->get['filter_telephone'])) {
			$url .= '&filter_telephone=' . (int)$this->request->get['filter_telephone'];
		}
	...
	public function info(): void {
		...
		$data['invoice_url'] = $this->url->link('sale/order.invoice', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $order_id);
        ...
        $this->load->model('sale/order');
        $invoice_info = $this->model_sale_order->getInvoice($order_id);

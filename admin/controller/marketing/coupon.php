...
class Coupon extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		$data['sort_minimum_total'] = $this->url->link('marketing/coupon.list', 'user_token=' . $this->session->data['user_token'] . '&sort=minimum_total' . $url);
	...
	public function form(): void {
		...
		if (!empty($coupon_info)) {
			$data['minimum_total'] = $coupon_info['minimum_total'];
		} else {
			$data['minimum_total'] = '';
		}

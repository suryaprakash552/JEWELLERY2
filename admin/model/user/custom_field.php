...
class CustomField extends \Opencart\System\Engine\Model {
	 ...
	 *
	 * $custom_field_id = $this->model_user_custom_field->addCustomField($custom_field_data);
	 */
	public function addCustomField(array $data): int {
		...
		if (isset($data['custom_field_user_group'])) {
			foreach ($data['custom_field_user_group'] as $custom_field_user_group) {
				if (isset($custom_field_user_group['user_group_id'])) {
					$this->addCustomerGroup($custom_field_id, $custom_field_user_group);
				}
			}
		}
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->editCustomField($custom_field_id, $custom_field_data);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteCustomField($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_info = $this->model_user_custom_field->getCustomField($custom_field_id);
	 */
	...
	public function getCustomFields(array $data = []): array {
		if (empty($data['filter_user_group_id'])) {
			...
			$sql = "SELECT * FROM `" . DB_PREFIX . "custom_field_user_group` `cfcg` LEFT JOIN `" . DB_PREFIX . "custom_field` `cf` ON (`cfcg`.`custom_field_id` = `cf`.`custom_field_id`) LEFT JOIN `" . DB_PREFIX . "custom_field_description` `cfd` ON (`cf`.`custom_field_id` = `cfd`.`custom_field_id`) WHERE `cfd`.`language_id` = '" . (int)$this->config->get('config_language_id') . "'";
		}
		...
		if (!empty($data['filter_user_group_id'])) {
			$sql .= " AND `cfcg`.`user_group_id` = '" . (int)$data['filter_user_group_id'] . "'";
		}
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_total = $this->model_user_custom_field->getTotalCustomFields($filter_data);
	 */
	public function getTotalCustomFields(): int {
		$query = $this->db->query("SELECT COUNT(*) AS `total` FROM `" . DB_PREFIX . "custom_field` WHERE `location` = 'Payroll'");
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->addDescription($custom_field_id, $language_id, $custom_field_data);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteDescriptions($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteDescriptionsByLanguageId($language_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_description = $this->model_user_custom_field->getDescriptions($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $results = $this->model_user_custom_field->getDescriptionsByLanguageId($language_id);
	 */
	 ...
	 * @example
	 *
	 * $custom_field_data['custom_field_user_group'] = [
	 *     'user_group_id' => 1,
	 *     'required'          => 0
	 * ];
	 *
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->addCustomerGroup($custom_field_id, $custom_field_data);
	 */
	public function addCustomerGroup(int $custom_field_id, array $data): void {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "custom_field_user_group` SET `custom_field_id` = '" . (int)$custom_field_id . "', `user_group_id` = '" . (int)$data['user_group_id'] . "', `required` = '" . (int)(isset($data['required']) ? 1 : 0) . "'");
	}
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteCustomerGroups($custom_field_id);
	 */
	public function deleteCustomerGroups(int $custom_field_id): void {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "custom_field_user_group` WHERE `custom_field_id` = '" . (int)$custom_field_id . "'");
	}
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_user_groups = $this->model_user_custom_field->getCustomerGroups($custom_field_id);
	 */
	public function getUserGroups(int $custom_field_id): array {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field_user_group` WHERE `custom_field_id` = '" . (int)$custom_field_id . "'");
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $value = $this->model_user_custom_field->addValue($custom_field_id, $custom_field_data);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteValues($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_value = $this->model_user_custom_field->getValue($custom_field_value_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_value = $this->model_user_custom_field->getValues($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->addValueDescription($custom_field_value_id, $custom_field_id, $language_id, $custom_field_value_description);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteValueDescriptions($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $this->model_user_custom_field->deleteValueDescriptionsByLanguageId($language_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $custom_field_values = $this->model_user_custom_field->getValueDescriptions($custom_field_id);
	 */
	 ...
	 * $this->load->model('customer/custom_field');
	 *
	 * $results = $this->model_user_custom_field->getValueDescriptionsByLanguageId($language_id);
	 */

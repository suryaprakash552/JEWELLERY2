...
class History extends \Opencart\System\Engine\Model {
    ...
    public function getOrderHistories($order_id, $start = 0, $limit = 10) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_aeps_history oh WHERE oh.order_id = '" . (int)$order_id . "' ORDER BY oh.date_added DESC LIMIT " . (int)$start . "," . (int)$limit);

		return $query->rows;
	}
	
	public function getTotalOrderHistories($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "order_aeps_history WHERE order_id = '" . (int)$order_id . "'");

		return $query->row['total'];
	}
	
	public function getProduct($order_id) {
		$query = $this->db->query("SELECT DISTINCT p.*,c.firstname,s.mobilenumber,s.firstname FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "customer c ON(c.customer_id=p.customerid) INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (p.enrollid=s.id) WHERE p.id = '" . (int)$order_id . "' AND p.language_id = '" . (int)$this->config->get('config_language_id') . "'");

		return $query->row;
	}
    
	public function getProducts($data = array()) {
		$sql = "SELECT p.*,s.mobilenumber FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		...
		if (isset($data['filter_aepsid']) && !empty($data['filter_aepsid'])) {
	...
	public function getTotalProducts($data = array()) {
		...
		$sql = "SELECT COUNT(DISTINCT p.id) total FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		...
		$sql = "SELECT sum(p.amount) total FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
...
public function getTotalFailed($data = array()) {
	...
	public function getTotalProductsByLayoutId($layout_id) {
		...
		public function getTotalAdminProfit($data = array()) {
		    if($data['filter_status']=='' || $data['filter_status']==1)
		    {
		$sql = "SELECT sum(p.admin) total FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		...
		public function getTotalAgentProfit($data = array()) {
		    if($data['filter_status']=='' || $data['filter_status']==1)
		    {
		$sql = "SELECT sum(p.profit) total FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		...
		public function getTotalUpwordProfit($data = array()) {
		    if($data['filter_status']=='' || $data['filter_status']==1)
		    {
		$sql = "SELECT sum(p.dt) dt,sum(p.sd) sd,sum(p.wt) wt FROM " . DB_PREFIX . "aeps_transaction_details p INNER JOIN " . DB_PREFIX . "aeps_enrollments s ON (s.id=p.enrollid) WHERE p.language_id = '" . (int)$this->config->get('config_language_id') . "'";
	...
	public function getTotalSuccessbyCustid($cust,$data = array()) {
		    ...
		    if($data['filter_status']=='' || $data['filter_status']==1)
		    {
		$sql = "SELECT sum(p.amount) total FROM " . DB_PREFIX . "aeps_transaction_details p WHERE p.customerid = '" . $cust . "'";

...
class Aadharcommission extends \Opencart\System\Engine\Model {
	...
	public function getProduct($packageid) {
		$sql = "SELECT * FROM " . DB_PREFIX . "manage_aadhar_commission_1 p where packageid='".$packageid."'";
	...
	public function editProduct($packageid,$data)
	{
		if (isset($data['commission'])) {
		     $this->db->query("DELETE FROM " . DB_PREFIX . "manage_aadhar_commission_1 WHERE packageid = '" . $packageid . "'");
			foreach ($data['commission'] as $commission) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "manage_aadhar_commission_1 SET     packageid = '" . $packageid . "', 
